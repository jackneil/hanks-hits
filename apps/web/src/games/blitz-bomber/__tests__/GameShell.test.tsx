...
import { BlitzBomberGameShell } from "../BlitzBomberGameShell";
import { useBlitzBomberStore } from "../lib/store";

describe("BlitzBomberGameShell pause wiring", () => {
  beforeEach(() => {
  ...
  it("adds a paused state and keeps the shell menu and game loop in lockstep", () => {
    ...
    // this, the plane kept flying/crashing behind the menu because there was no
    // paused state at all.
    fireEvent.keyDown(window, { key: "Escape", code: "Escape" });
    expect(useBlitzBomberStore.getState().gameState).toBe("paused");
