...
const ROWS: Row[] = [
  {
    ...
    turn2d: 0.062,
    mass: 320,
    chassis: { length: 1.9, width: 1.1, height: 0.6 },
    // A real quad carries the wheels beside its fenders, not tucked under the seat.
    wheelRadius: 0.35,
    inset: 0.03,
    stiffness: 32,
    restLength: 0.3,
  ...
  },
  {
    ...
    turn2d: 0.068,
    mass: 700,
    chassis: { length: 2.6, width: 1.5, height: 0.8 },
    wheelRadius: 0.38,
    inset: 0.2,
    stiffness: 26,
    restLength: 0.3,
  ...
  },
  {
    ...
    turn2d: 0.046,
    mass: 2600,
    chassis: { length: 5.6, width: 2, height: 1.4 },
    wheelRadius: 0.45,
    inset: 0.28,
    stiffness: 24,
    restLength: 0.32,
  ...
  },
  {
    ...
    turn2d: 0.084,
    mass: 200,
    chassis: { length: 2.1, width: 0.5, height: 0.6 },
    wheelRadius: 0.33,
    inset: 0.1,
    stiffness: 26,
    restLength: 0.28,
  ...
  },
  {
    ...
    turn2d: 0.072,
    mass: 1600,
    chassis: { length: 4.5, width: 2, height: 1.1 },
    wheelRadius: 0.35,
    inset: 0.24,
    stiffness: 32,
    restLength: 0.24,
  ...
  },
  {
    ...
    turn2d: 0.034,
    mass: 9000,
    chassis: { length: 7.5, width: 2.5, height: 3 },
    wheelRadius: 0.55,
    inset: 0.35,
    stiffness: 22,
    restLength: 0.34,
  ...
  },
  {
    ...
    turn2d: 0.036,
    mass: 12000,
    chassis: { length: 8, width: 2.5, height: 3.2 },
    wheelRadius: 0.58,
    inset: 0.35,
    stiffness: 22,
    restLength: 0.34,
  ...
  },
  {
    ...
    turn2d: 0.044,
    mass: 3500,
    chassis: { length: 4.5, width: 2.6, height: 2.4 },
    wheelRadius: 0.9,
    inset: 0.4,
    stiffness: 20,
    restLength: 0.5,
  ...
  },
  {
    ...
    turn2d: 0.078,
    mass: 800,
    chassis: { length: 4.6, width: 1.9, height: 1 },
    wheelRadius: 0.36,
    inset: 0.22,
    stiffness: 34,
    restLength: 0.22,
  ...
  },
  {
    ...
    turn2d: 0.068,
    mass: 1700,
    chassis: { length: 4.9, width: 1.9, height: 1.3 },
    wheelRadius: 0.4,
    inset: 0.24,
    stiffness: 28,
    restLength: 0.28,
  ...
  },
  {
    ...
    turn2d: 0.05,
    mass: 3000,
    chassis: { length: 3.5, width: 1.8, height: 2.2 },
    wheelRadius: 0.75,
    inset: 0.3,
    stiffness: 20,
    restLength: 0.4,
  ...
  },
  {
    ...
    turn2d: 0.034,
    mass: 7000,
    chassis: { length: 8, width: 2.4, height: 3 },
    wheelRadius: 0.5,
    inset: 0.32,
    stiffness: 22,
    restLength: 0.34,
  ...
  },
  {
    ...
    turn2d: 0.062,
    mass: 100,
    chassis: { length: 1.7, width: 0.5, height: 0.6 },
    wheelRadius: 0.34,
    inset: 0.08,
    stiffness: 24,
    restLength: 0.24,
  ...
  },
  {
    ...
    label: "On Foot",
    emoji: "🦶",
    max2d: FOOT_SPEEDS.walk / SCALE.SPEED,
    accel2d: 0.6,
    brake2d: 0.6,
    rev2d: -FOOT_SPEEDS.walk / SCALE.SPEED,
    turn2d: 0.075,
    mass: 70,
    chassis: { length: 0.5, width: 0.5, height: 1.7 },
    wheelRadius: 0.2,
    inset: 0.1,
    stiffness: 24,
    restLength: 0.2,
...
export const VEHICLE_TUNING: Record<VehicleId, VehicleTuning> =
  Object.fromEntries(ROWS.map((row) => [row.id, tune(row)])) as Record<
    VehicleId,
    VehicleTuning
  >;
for (const [id, label, mph, price] of BIKES) {
  VEHICLE_TUNING[id] = {
    ...VEHICLE_TUNING.bike,
    id,
    label,
    price,
    maxSpeed: (mph / 14) * 8 * SCALE.SPEED,
  };
}
